...
if __name__ == "__main__":
    ...
    summary.create_hyperparameter(num_train_epochs=5, push_to_hub=True, hub_model_id="Chessmen/"+"TF_fine_tune_" + summary.other_name)
    ...
    summary.call_pipeline(path="Chessmen/TF_fine_tuned_"+ summary.other_name, example= "Muy apropiado para mis hijas")
